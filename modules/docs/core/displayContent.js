...
function displayInFrames()
{
    ...
    if(!args['skipReload'])
    {
      window.focus();
        if (!cookiesAccepted())
        {
            var alertStr = "WebLogic Server documentation uses cookies to enable coordination\n" + " of displayed topics with the Table of Contents.\n\n" + "Your browser is currently not accepting cookies. Please enable\n" + "cookies to access WebLogic Server documentation.";
            alert(alertStr);
            return;
        }
